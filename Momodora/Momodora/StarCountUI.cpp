...
void StarCountUI::Render(HDC hdc)
{
	...
	CAMERAMANAGER->GetMainCamera()->ScaleRender(hdc, mHundredImage, mRect.right + mHundredSizeX, mY, mHundredSizeX, mHundredSizeY);
	CAMERAMANAGER->GetMainCamera()->ScaleRender(hdc, mTenImage, mRect.right + mHundredSizeX + mTenSizeX , mY, mTenSizeX, mTenSizeY);
	CAMERAMANAGER->GetMainCamera()->ScaleRender(hdc, mOneImage, mRect.right + mHundredSizeX + mTenSizeX  + mOneSizeX, mY, mOneSizeX, mOneSizeY);
}
